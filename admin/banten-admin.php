...
<html>
    <head>
        ...
        <!-- Morris chart -->
        <link href="../dist/css/morris/morris.css" rel="stylesheet" type="text/css" />
        <!-- jvectormap -->
        <link href="../dist/css/jvectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
        <!-- Date Picker -->
        <link href="../dist/css/datepicker/datepicker3.css" rel="stylesheet" type="text/css" />
        <!-- Daterange picker -->
        <link href="../dist/css/daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css" />
